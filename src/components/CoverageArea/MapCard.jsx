...
export const MapCard = () => {
  return (
    <div className="space-y-4 sm:space-y-6 text-white grid grid-cols-2  gap-4 sm:gap-6 w-full max-w-lg">
      {AreaConst.map((item, index) => (
        <div
          key={index}
          className="flex gap-2 sm:gap-3 justify-start items-center">
